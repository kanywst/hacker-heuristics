...
export const laws: Law[] = [
  ...
  },
  {
    ...
    "ja": {
      ...
      "guideline": "ユーザーがいる限り「内部実装」は存在しない。すべての変更は破壊的変更であると想定し、厳格なバージョニングと機能フラグを使え。",
  ...
  },
  {
    ...
    "en": {
      ...
      "counter": {
        "name": "Calibrated Confidence / Structured Skill Assessment"
      },
    ...
    "ja": {
      "title": "ダニング・クルーガー効果",
      "concept": "メタ認知の盲点。",
      "mechanism": "ある分野で専門性を欠くということは、「自分の無能さを認識するために必要なメタ的スキル」も同時に欠くということ。初心者は自分を熟達者と同じパーセンタイルに評価する。一方で本当の熟達者は、他人も自分と同じ理解を持っていると仮定し、自分を過小評価することが多い。",
      "counter": {
        "name": "較正された自信 / 構造化されたスキル評価"
      },
