...
## 47. 分散コンピューティングの誤謬 (Fallacies of Distributed Computing)
...
- **出典:** L. Peter Deutsch（誤謬 5〜7、1994年）と James Gosling（8つ目、1997年頃）——Sun Microsystems での先行研究に基づく。

## 48. 自動化の皮肉 (Ironies of Automation)
...
- **出典:** Lisanne Bainbridge, *Ironies of Automation* (Automatica, 1983)。

## 49. 最小権限の原則 (Principle of Least Privilege)
...
- **出典:** Jerome Saltzer & Michael Schroeder, *The Protection of Information in Computer Systems* (Proceedings of the IEEE, 1975)。

## 50. ケルクホフスの原理 (Kerckhoffs's Principle)
...
- **出典:** Auguste Kerckhoffs, *La cryptographie militaire* (Journal des sciences militaires, 1883)。

## 51. グスタフソンの法則 (Gustafson's Law)
...
- **出典:** John L. Gustafson, *Reevaluating Amdahl's Law* (Communications of the ACM, 1988)。

## 52. スケールの裾野 (The Tail at Scale)
...
- **出典:** Jeffrey Dean & Luiz André Barroso, *The Tail at Scale* (Communications of the ACM, 2013)。

## 53. アシュビーの必要多様性の法則 (Ashby's Law of Requisite Variety)
...
- **出典:** W. Ross Ashby, *An Introduction to Cybernetics* (Chapman & Hall, 1956)。

## 54. デメテルの法則 (Law of Demeter)
...
- **出典:** Karl Lieberherr & Ian Holland, *Assuring Good Style for Object-Oriented Programs* (IEEE Software, 1989)。

## 55. ジェヴォンズのパラドックス (Jevons Paradox)
...
- **出典:** William Stanley Jevons, *The Coal Question* (1865)。

## 56. 通常事故理論 (Normal Accident Theory)
...
- **出典:** Charles Perrow, *Normal Accidents: Living with High-Risk Technologies* (Basic Books, 1984)。
